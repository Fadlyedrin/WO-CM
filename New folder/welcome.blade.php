                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="package-card shadow-sm elegant-card p-0 d-flex flex-column">
                            ...
                            <div class="p-4 d-flex flex-column flex-grow-1">
                                ...
                                <p class="text-muted small mb-4 flex-grow-1">{{ Str::limit(strip_tags($package->description), 100) }}
                                </p>
    ...
    <section class="about-section fade-in-up">
        <div class="container px-4 px-lg-5">
            <div class="row align-items-center flex-lg-row-reverse">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <img src="https://images.unsplash.com/photo-1583939003579-730e3918a45a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
...
@section('styles')
    <style>
        ...
        .hero-section {
            ...
            height: 100vh;
            margin: 0;
            background-image: url('https://upicc.id/wp-content/uploads/2025/01/pelaminan-upi-cc.jpg');
        ...
        @media (max-width: 991px) {
            ...
            .services-section, .packages-section, .portfolio-section, .about-section, .testimonials-section {
                padding: 4rem 0;
            }
        ...
        @media (max-width: 768px) {
            ...
            .services-img, .about-img { height: 320px; margin-bottom: 2rem; }

            .package-card-img { height: 200px; }
            .package-price { font-size: 1.5rem; }

            .services-section, .packages-section, .portfolio-section,
            .about-section, .testimonials-section { padding: 3rem 0; }
        ...
        @media (max-width: 480px) {
            ...
            .services-img, .about-img { height: 250px; }

            .services-section, .packages-section, .portfolio-section,
            .about-section, .testimonials-section { padding: 2.5rem 0; }

            /* vendor cta on show page */
            .vendor-cta { gap: 0.75rem; }
        }
    </style>
@endsection
